...
elsewhere = ()
fixtures = (
    ("driver", "input_processor_temp_layer_touch.c", (
        "pack_params",
        "unpack_params",
        "stream_for_event",
        "trigger_layer_allowed",
        "hold_layer",
        "drop_layer",
        "follow_discarded_touch",
        "stop_event",
        "temp_layer_touch_handle_event",
        "temp_layer_touch_init",
        "temp_layer_touch_device_valid",
        "temp_layer_touch_get_params",
        "temp_layer_touch_set_params",
    ), ()),
    ("custom_settings", "input_processor_temp_layer_touch_custom_settings.c", (
        "temp_layer_touch_namespace_handler",
        "read_bool",
        "read_int32",
        "temp_layer_touch_check_unique_keys",
        "#define TEMP_LAYER_TOUCH_APPLY",
        "temp_layer_touch_apply_settings",
        "temp_layer_touch_settings_event_cb",
    ), ()),
)
